    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-0 d-block">
        <div class="collapse d-block" id="navbarSupportedContent">
            <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item dropdown <?php if(isset($_REQUEST['c']) && $_REQUEST['c'] == 'Qcm') { echo 'active'; } ?>">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">QCM</a>
                    <div class="dropdown-menu bg-dark">
                        <a class="dropdown-item text-white" href="?c=Qcm">Tous les QCM</a>
                        <a class="dropdown-item text-white" href="?c=Qcm&m=add">Ajouter un QCM</a>
                    </div>
                </li>
                <li class="nav-item">
